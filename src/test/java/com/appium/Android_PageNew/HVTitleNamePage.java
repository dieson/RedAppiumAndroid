...
public class HVTitleNamePage extends BaseScreen {
	...
	private static final Properties HVTITLENAME_PAGE_PROPERTIES = new PropertyUtils().loadProperties("/Android_pageNew/HVTitleName.properties");
	...
	do {
		...
		//String titleOnIndex = screen.getText(nameOnContent, "Title name on Index.");
